...
class AutoModelForPragraphRanking:
    def __init__(self):
    ...
    def from_config(cls, config):
        ...
        """
        for config_class, model_class in MODEL_FOR_PARAGRAPH_RANKING_MAPPING.items():
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                config.__class__,
                cls.__name__,
                ", ".join(c.__name__ for c in MODEL_FOR_PARAGRAPH_RANKING_MAPPING.keys()),
            )
        )
